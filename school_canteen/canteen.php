                ...
                <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/2.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <img src="images/logo/<?php echo $canteen['image']; ?>" alt="Product Image" style="border-radius: 50%; padding: 10px; width: 110px; height: 110px;">
                            ...
                            <div class="carousel-item" style="background-image: url(images/announcement/<?php echo $row['i_image']; ?>)">
                                <div class="carousel-container">
                                    <div class="container">
                                        ...
                                        <a href="<?php echo $canteen['url']; ?>" class="btn-get-started scrollto animate__animated animate__fadeInUp">visit our social media</a>

                                        <p class="animate__animated animate__fadeInUp"><?php echo $canteen['school_name']; ?></p>
                                    </div>
                                </div>
                            </div>
                    <?php
                ...
                <div class="display-content" style="display: none">
                    <div class="row">
                        ...
                        if (isset($_POST['search_value'])) {
                          ...
                          $query = "SELECT * FROM `dishes` WHERE   s_id ='" . $s_id . "' AND CONCAT(s_id,dishes_name,c_name,d_image) LIKE '%$value_search%' ";
                            $all_products = $db->query($query);

                            if (mysqli_num_rows($all_products) > 0) {
                                foreach ($all_products as $items) {
                                    if ($items['stock'] > 0 || $items['s_id'] = $s_id) { ?>
