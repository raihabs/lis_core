                                            ...
                                            <form id="UpdateOrder">
                                                ...
                                                <div class="page">
                                                    <div class="display-content" style="display: none">
                                                        ...
                                                        $sql_order = "SELECT * FROM `users_orders` WHERE s_id = '" . $adm_id . "' AND status = 'In Process' ";
                                                    ...
                                                    WHERE s_id = '" . $adm_id . "' AND status = 'In Process' GROUP BY order_code
                                                    ORDER BY `name_count` DESC";
                                                            $items_code = mysqli_query($db, $query_code);
                                                            foreach ($items_code as $code) {

                                                                $sql_product = "SELECT *  FROM `users_orders` WHERE s_id = '" . $adm_id . "' AND status = 'In Process' AND order_code = '" . $code['order_code'] . "' ";
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <div class="display">
                                                                        ...
                                                                        <div class="display-info">
                                                                            ...
                                                                            ?>
                                                                            <input type="hidden" name="prodid[]" class="form-control" value="<?php echo $product['order_code']; ?>">
                                                                            <input type="hidden" name="prodname[]" class="form-control" value="<?php echo $product['order_code']; ?>">
                                                                            <input type="hidden" name="order_id[]" class="form-control" value="<?php echo $product['o_id']; ?>">
                                                                            <input type="hidden" name="order_date[]" class="form-control" value="<?php echo $created_date; ?>">
                                                                            <input type="hidden" name="status[]" class="form-control" value="<?php echo $status_in_process = "On The Way"; ?>">
                                                            ...
                                                            <div class="display">
                                                                ...
                                                                <div class="display-info">
                                                                    ...
                                                                    <div style="align-items:center; display:flex; margin-top:7%; padding: 20px;justify-content: center;">
                                                                        ...
                                                                        <div class="row">
                                                                            All IN PROCESS order data in your DATABASE is empty..
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        success: function(response) {
                            ...
                            if (res.status == 400) {
                                ...
                                Swal.fire({
                                    ...
                                    location.href = '/CFOS/admin/user_order_ontheway_view.php';
                                });
                            }
                        }
                    })
