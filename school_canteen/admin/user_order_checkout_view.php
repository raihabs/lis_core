                                            ...
                                            <form id="UpdateOrder">
                                                ...
                                                <div class="page">
                                                    <div class="display-content" style="display: none">
                                                        ...
                                                        $sql_order = "SELECT * FROM `users_orders` WHERE s_id = '" . $adm_id . "' AND status = 'Delivered' ";
                                                    ...
                                                    WHERE s_id = '" . $adm_id . "' AND status = 'Delivered' GROUP BY order_code
                                                    ORDER BY `name_count` DESC";
                                                            $items_code = mysqli_query($db, $query_code);
                                                            foreach ($items_code as $code) {

                                                                $sql_product = "SELECT *  FROM `users_orders` WHERE s_id = '" . $adm_id . "' AND status = 'Delivered' AND order_code = '" . $code['order_code'] . "' ";
