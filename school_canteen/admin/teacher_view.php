        ...
        <div class="main-content">
            ...
            <div class="row" style=" padding: 1rem 0; background-color: #fff;">
                ...
                <!-- <div class="col-2 align-self-right">
                    <button type="button" class="btn float-end" data-bs-toggle="modal" data-bs-target="#addTeacher" style=" background-color:#6c8cc4; color:white; font-size:15px; color:white; margin-left:225%; ">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Teacher data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="canteen_table">
                                            ...
                                            $query = "SELECT * FROM `users`  WHERE user_type = 'teacher' AND s_id = '" . $adm_id . "' ORDER BY `u_id`";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr id="<?php echo $row['u_id']; ?>" class="text-center">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-danger btn-sm m-b-10 teacher_delete button2" data-role="update" id="<?php echo $row['u_id']; ?>"><i class='bx bxs-trash-alt' style="color:white;"></i></button>
                                                            <button class="btn btn-info btn-sm m-b-10 teacher_edit button1" data-bs-toggle="modal" data-bs-target="#updateTeacher" value="<?= $row['u_id']; ?>" data-role="update" id="<?php echo $row['u_id']; ?>"><i class='bx bx-cog' style="color: white;"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
                                                ...
                                                <td colspan="11">
                                                    <center>No Teacher-Data-Found!</center>
                                                </td>
                                            <?php }
                                            ?>
                                        </tbody>
            ...
            <!-- Add Modal -->
            <div class="modal fade" id="addTeacher" tabindex="-1" aria-labelledby="teacherModal" aria-hidden="true" style=" background-color: rgba(0,0,0,0.7);">
            ...
            <!-- Update Modal -->
            <div class="modal fade" id="updateTeacher" tabindex="-1" aria-labelledby="teacherModal" aria-hidden="true" style=" background-color: rgba(0,0,0,0.7);">
                <div class="modal-dialog">
                    <div class="modal-content" style="width:600px;">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add Student</h5>
...
<script>
    ...
    $(document).on('submit', '#saveteacher', function(e) {
        ...
        formData.append("valid_teacher", true);
        {
            Swal.fire({
                title: 'Do you want to save the teacher info?',
                showDenyButton: true,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "teacher_process.php", //action
                        data: formData,
                        processData: false,
                        contentType: false,
    ...
    $(document).ready(function(){
        ...
        $(document).on('submit', '#editteacher', function(e) {
            ...
            Swal.fire({
                title: 'Do you want to Update Teacher?',
                showDenyButton: true,
                showCancelButton: true,
