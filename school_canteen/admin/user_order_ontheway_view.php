                                            ...
                                            <form id="UpdateOrder">
                                                ...
                                                <div class="page">
                                                    <div class="display-content" style="display: none">
                                                        ...
                                                        $sql_order = "SELECT * FROM `users_orders` WHERE s_id = '" . $adm_id . "' AND status = 'On The Way' ";
                                                    ...
                                                    WHERE s_id = '" . $adm_id . "' AND status = 'On The Way' GROUP BY order_code
                                                    ORDER BY `name_count` DESC";
                                                            $items_code = mysqli_query($db, $query_code);
                                                            foreach ($items_code as $code) {

                                                                $sql_product = "SELECT *  FROM `users_orders` WHERE s_id = '" . $adm_id . "' AND status = 'On The Way' AND order_code = '" . $code['order_code'] . "' ";
                                                        ...
                                                        ?>
                                                                        ...
                                                                        <div class="display">
                                                                            ...
                                                                            <div class="display-info">
                                                                                ...
                                                                                ?>
                                                                                <input type="checkbox" name="prodid[]" value="<?php echo $product['order_code']; ?>"> CHECK TO BE DELIVER/ UNCHECK IF NOT
                                                                                ...
                                                                                <input type="hidden" name="status[]" class="form-control" value="<?php echo $status_in_process = "Delivered"; ?>">
                                                                ...
                                                                <div class="display">
                                                                    ...
                                                                    <div class="display-info">
                                                                        ...
                                                                        <div style="align-items:center; display:flex; margin-top:7%; padding: 20px;justify-content: center;">
                                                                            ...
                                                                            <div class="row">
                                                                                All ON THE WAY order data in your DATABASE is empty..
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            </div>
