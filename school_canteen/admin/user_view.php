        ...
        <div class="main-content">
            ...
            <div class="row" style=" padding: 1rem 0; background-color: #fff;">
                ...
                <div class="col-2 align-self-right">
                    <button type="button" class="btn float-end" data-bs-toggle="modal" data-bs-target="#addTeacher" style=" background-color:#6c8cc4; color:white; font-size:14px; width: 120px;color:white; margin-left: 90%; ">
                        <b class="pb-2" style="color:white;">Add teacher</b>
                    </button>
                </div>
                <div class="col-2 align-self-right">
                    <button type="button" class="btn float-end" data-bs-toggle="modal" data-bs-target="#addStudent" style=" background-color:#6c8cc4; color:white; font-size:14px; width: 120px;color:white; margin-left: 90%; ">
                        <b class="pb-2" style="color:white;">Add Student</b>
                    </button>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All USername data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="canteen_table">
                                            ...
                                            $query = "SELECT * FROM `username` WHERE s_id = '" . $adm_id . "' ORDER BY `us_id` DESC";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr id="<?php echo $row['u_id']; ?>" class="text-center">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-danger btn-sm m-b-10 student_delete button2" data-role="update" id="<?php echo $row['us_id']; ?>"><i class='bx bxs-trash-alt' style="color:white;"></i></button>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="grade" id="grade" class="form-control custom-select" data-placeholder="Choose Grade" tabindex="1" onchange="FetchAddSection(this.value)">
                                                <?php
                                                $query = "SELECT sc_id, g_id, grade, COUNT(*) as name_count FROM section GROUP BY grade";
            ...
            <!-- Add Modal -->
            <div class="modal fade" id="addTeacher" tabindex="-1" aria-labelledby="studentModal" aria-hidden="true" style=" background-color: rgba(0,0,0,0.7);">
                <div class="modal-dialog">
                    <div class="modal-content" style="width:600px;">
                        <div class="modal-header">
