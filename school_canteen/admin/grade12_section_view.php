                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="canteen_table">
                                            ...
                                            $query = "SELECT * FROM `section`  WHERE grade =  12 AND s_id = '" . $adm_id . "' ORDER BY `sc_id`";
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="grade" value="12" class="form-control" placeholder="grade" readonly>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Grade</label>
                                            <input type="text" id="grade" name="grade" value="12" class="form-control" placeholder="grade" readonly>
                                        </div>
                                    </div>
                                </div>
