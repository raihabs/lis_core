...
include '../call_func/session_alert.php';
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('../images/school-background/school_picture.jpg');">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="<?= BASE_URL ?>teacher_login/resetprocess.php" method="POST">
                    ...
                    <div class="container-login100-form-btn">
                        <button type="submit" name="check-email" class="login100-form-btn">
                            Continue
                        </button>
                    </div>
                </form>
